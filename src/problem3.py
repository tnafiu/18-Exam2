...
class Cloud(object):
 ...
 s
        ...
        self.water = water
        self.amount_water_from_cloud = 0
    ...
    def rain(self, rain_amount):
        ...
        if rain_amount <= self.water:
            self.amount_water_from_cloud = rain_amount
            self.water = self.water - rain_amount
            self.total_rain_amount = self.total_rain_amount + self.amount_water_from_cloud
        else:
            self.amount_water_from_cloud = self.water
            self.water = 0
            self.total_rain_amount = self.total_rain_amount + self.amount_water_from_cloud
        return self.amount_water_from_cloud
