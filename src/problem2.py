...
def problem2a(triangle):
    ...
    # -------------------------------------------------------------------------
    side_len_a = 2*triangle.a
    side_len_b = 2*triangle.b
    side_len_c = 2*triangle.c
    new_triangle = Triangle(side_len_a, side_len_b, side_len_c)
    return new_triangle
...
def problem2b(triangles):
    ...
    for k in range(len(triangles)):
        area_sum = area_sum + triangles[k].get_area()
    return area_sum
